...
module.exports = class App {
  ...
  static shouldBootstrap = undefined;
  ...
  init({noEngine = false} = {}) {
    ...
    if (undefined === App.shouldBootstrap) {
      App.shouldBootstrap = !fs.existsSync(this._dir);
    }
     ...
     */
    .then(() => !App.shouldBootstrap || noEngine === true ? undefined : this.events.emit('pre-bootstrap', this))
 ...
 /**
  ...
  start() {
     ...
     * @property {App} app The app instance.
     */
    .then(() => App.shouldBootstrap ? this.events.emit('post-bootstrap', this) : undefined)
